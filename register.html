		...
		<div class="container-fluid no-gutters pt-5 " >
			<div class="row justify-content-center" >
				...
				<div class="col-4 p-4  text-white  h4 shadow-lg rounded" style="background-color: #4F788D">
					...
					<form class="h6 pt-2" action="login.html">
						<div class="form-group">
							...
							<div class="col-12">
								<input type="text" id="text" class="form-control" placeholder="Twoje imie">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-12">
								<input type="email" id="email" class="form-control" placeholder="Twoj email">
							</div>
						</div>
